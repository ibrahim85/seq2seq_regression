...
options = {
    ...
    'restore_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model6_clean/mon_bahdanau/seq2seq_train_cc_largemodel_ss100_mbahdanau_0init_outstate_era1_final",  # "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model4/monotonic_bahdanau/seq2seq_train_cc_largemodel_ss100_mbahdanau_0init_outstate_era1_final",  # path to mlodel to restore

    'save': False,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model6_clean/mon_bahdanau/seq2seq_train_cc_largemodel_ss100_mbahdanau_0init_outstate_era1",
