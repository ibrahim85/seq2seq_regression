...
options = {
    ...
    'attention_type': 'monotonic_luong',
    ...
    'max_in_len': 100,  # maximum number of frames in input videos
    'max_out_len': 100,  # maximum number of characters in output text
    ...
    'restore_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model6_clean/mon_luong/seq2seq_train_largemodel_cc_ss100_mluong_0init_outstate_era1_final",  # "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model4/monotonic_luong/seq2seq_train_largemodel_cc_ss100_mluong_0init_outstate_era1_final",  # path to model to restore

    'save': False,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model6_clean/mon_luong/seq2seq_train_largemodel_cc_ss100_mluong_0init_outstate_era1",
