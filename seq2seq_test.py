...
options = {
    ...
    'split_name': 'devel',
    'batch_size': 200,   # number of examples in queue either for training or inference
    'reverse_time': False,
    'shuffle': True,
    ...
    'restore_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model3_all_mfcc/seq2seq_train_concordancecc_ss020_era3_final",  # path to model to restore

    'save': False,  # boolean. save model to disk during current era
    'save_model': "/data/mat10/MSc_Project/audio_to_3dvideo/Models/model3_all_mfcc/seq2seq_train_concordancecc_era2",
