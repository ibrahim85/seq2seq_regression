...
from mixed_seq_models import CNNRNNModel_raw3
...
options = {
    ...
    'save_model': "/data/mat10/Projects/audio23d/Models/seq_cnn_raw3/seq_cnn_raw3_lstm_batchnorm_all_melf_cc_era1",
    'num_models_saved': 100,  # total number of models saved
    'save_steps': 500,  # every how many steps to save model

    'save_graph': False,
    'save_dir': "/data/mat10/Projects/audio23d/Models/seq_cnn_raw3/summaries",
    'save_summaries': True
...
if __name__ == "__main__":
    ...
    model = CNNRNNModel_raw3(options)
